...
use RocketMQ\Common\Help\FAQUrl;
...
class DefaultMQProducer
{
    ...
    /**
     * @param Message $msg
     * @param int $communicationMode
     * @param null $sendCallback
     * @param int $timeout
     * @throws MQClientException
     */
    public function send(
        Message $msg,
        int $communicationMode = CommunicationMode::SYNC,
        $sendCallback = null,
        int $timeout = null
    ) {
        ...
        if ($topicPublishInfo != null && $topicPublishInfo->ok()) {
            ...
            $exception = null;
            $sendResult = null;
            $timesTotal = $communicationMode === CommunicationMode::SYNC
                ...
                if ($tmpmq != null) {
                    ...
                    try {
                        ...
                        $this->log->warn(sprintf(
                            ...
                            invokeID,
                            endTimestamp - beginTimestampPrev,
                            mq
                        ), $e);
